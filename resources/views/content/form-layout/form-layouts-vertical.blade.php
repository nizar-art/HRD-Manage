      ...
      <div class="card-body">
        <div class="tab-content p-0">
          ...
          <div class="tab-pane fade" id="form-tabs-account" role="tabpanel">
            <form>
              <div class="col-12">
                <!-- Card container will be inserted here -->
                <div id="educationContainer">
                  <!-- Initial card item (hidden template) -->
                  <div class="card mb-3" id="educationItemTemplate" style="display:none;">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-3 col-12">
                          ...
                          <input type="text" class="form-control" placeholder="Masukkan Nama Sekolah atau Instansi" />
                        </div>
                        <div class="col-lg-6 col-xl-3 col-12">
                        ...
                        <div class="col-lg-6 col-xl-2 col-12">
                          ...
                          <input type="number" class="form-control" placeholder="Tahun Lulus" min="1900" max="2099" step="1" />
                        </div>
                        <div class="col-lg-12 col-xl-2 col-12 d-flex align-items-end">
                          <button class="btn btn-label-danger deleteBtn">
                ...
                <!-- Button to add new education history card -->
                <div class="mb-0">
...
<script>
  ...
  const educationItemTemplate = document.getElementById('educationItemTemplate');

  addEducationButton.addEventListener('click', function() {
    const newEducationItem = educationItemTemplate.cloneNode(true);
    newEducationItem.style.display = 'block';
    newEducationItem.removeAttribute('id'); // Ensure ID uniqueness
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  nextStepButton.addEventListener('click', function('forms-switches') {
    // Lakukan aksi yang Anda inginkan, seperti berpindah ke langkah berikutnya
    // Misalnya, menunjukkan langkah atau form berikutnya
    console.log('Next button clicked');

    // Sebagai contoh, Anda bisa menyembunyikan bagian saat ini dan menampilkan bagian berikutnya
    // Misalnya, jika ada elemen dengan ID 'currentStep' dan 'nextStep':
    document.getElementById('currentStep').style.display = 'none';  // Sembunyikan langkah saat ini
    document.getElementById('nextStep').style.display = 'block';    // Tampilkan langkah berikutnya
  });
});
