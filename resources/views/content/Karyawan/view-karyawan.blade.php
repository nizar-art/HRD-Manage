              ...
              <div class="row">
                  ...
                  <div class="table-responsive border border-bottom-0 border-top-0 rounded">
                      <table class="table m-0">
                          ...
                          <tbody>
                              <tr>
                                  <td class="text-nowrap">{{ $dataKeluarga->nama_lengkap }}</td>
                                  <td class="text-center">{{ $dataKeluarga->status }}</td> <!-- Asumsi status adalah hubungan -->
                                  <td class="text-center">{{ $dataKeluarga->nomer_hp }}</td>
                              </tr>
                          </tbody>
                      </table>
                  </div>
