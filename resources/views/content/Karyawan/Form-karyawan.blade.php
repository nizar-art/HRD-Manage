                        ...
                        <div id="data-pribadi" class="content">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-sm-12 mb-6">
                                        <select id="kabupaten_domisili" name="alamat_domisili[kabupaten]"
                                            class="select2">
                                            <option selected disabled>Pilih Kabupaten</option>
                                        </select>
                                    </div>
                                    <div class="col-xl-4 col-md-6 col-sm-12 mb-6">
                                        <select id="kecamatan_domisili" name="alamat_domisili[kecamatan]"
                                            class="select2">
                                            <option selected disabled>Pilih Kecamatan</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-12 mb-6">
                                        ...
                                        <input type="number" id="nomor_nik_ktp" name="nomor_nik_ktp"
                                            class="form-control" placeholder="Masukkan Nomor NIK KTP" required />
                                    </div>
                        ...
                        <div id="data-keluarga" class="content">
                            ...
                            <div id="familyContainer">
                                <div class="mb-3" id="familyItemTemplate" style="display:none;">
                                    <div class="card-body">
                                        <div class="row">
                                            <input name="id_karyawan" id="id_karyawan"
                                                value="{{ $karyawanId }}">
                                            <div class="col-lg-4">
